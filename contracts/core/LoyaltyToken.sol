...
contract LoyaltyToken is ERC1155, Ownable {
    ...
    constructor() ERC1155("") Ownable(msg.sender) {
        // Set metadata URIs for badge assets - can be updated via setTokenURI
        _setTokenURI(BRONZE_BADGE, "https://kudobit-demo.github.io/metadata/bronze-badge.json");
        _setTokenURI(SILVER_BADGE, "https://kudobit-demo.github.io/metadata/silver-badge.json");
        _setTokenURI(GOLD_BADGE, "https://kudobit-demo.github.io/metadata/gold-badge.json");
        _setTokenURI(DIAMOND_BADGE, "https://kudobit-demo.github.io/metadata/diamond-badge.json");
    }
