    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="bg-card rounded-lg shadow-sm p-8 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-chart-3/20 rounded-full"></div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-chart-5/20 rounded-full"></div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-lg p-8 border">
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">Accessible components</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-primary" />
          ...
          <div className="bg-gradient-to-br from-chart-2/5 to-chart-2/10 rounded-lg p-8 border">
            <div className="flex items-center mb-4">
              <Globe className="h-8 w-8 text-chart-1  mr-3" />
              <h3 className="text-xl font-semibold text-foreground">
                Modern Standards
              </h3>
            </div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">Modern React patterns</span>
              </li>
              <li className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-chart-2" />
                <span className="text-muted-foreground">Performance optimized</span>
              </li>
            </ul>
          </div>
        </div>
